...
# Listas con datos
productos = ["Arroz", "Aceite", "Azúcar", "Pan", "Leche", "Huevos", "Queso", "Jamón", "Carne", "Tomate", "Cebolla", "Lechuga", "Manzana", "Plátano", "Naranja", "Uvas", "Pera", "Piña", "Melón", "Sandía", "Mango"]
cantidades = [2, 1, 3, 1, 12, 6, 4, 2, 5, 3, 1, 4, 6, 3, 2, 5, 1, 1, 1, 2, 3]
preciounitario = [1500, 4250, 1400, 750, 600,]
...
# Mostrar factura
print("{:<12} {:<10} {:<15} {:<15} {:<15}".format("Producto", "Cantidad", "Precio", "IVA", "Total"))
print("-"*60)
